...
class TestHrCourse(common.TransactionCase):
    def setUp(self):
        ...
        self.course_schedule_id = self.env["hr.course"].create(
            {
                "name": "Course name at Feb",
    ...
    def test_hr_course(self):
        ...
        self.course_schedule_id.permanence = False
        self.course_schedule_id._onchange_permanence()
        self.assertFalse(self.course_schedule_id.permanence_time)
        ...
        self.course_schedule_id.attendant_ids = [(6, 0, [self.employee1.id, self.employee2.id])]
        ...
        self.assertEqual(self.course_schedule_id.course_attendee_ids[0].result, "passed")
        self.course_schedule_id.validation2complete()
